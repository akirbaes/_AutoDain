...
python "%~dp0\DAINAUTO_utils\crop_image.py" "%%~dpnA interp_D4.gif" -1

"%~dp0\gifsicle.exe" --colors=255 "%%~dpnA interp_D4+-1.gif" -o "%%~dpnA interp_D4+-1.gif"
"%~dp0\gifsicle.exe" -U "%%~dpnA interp_D4+-1.gif" -o "%%~dpnA interp_D4.gif"

del "%%~dpnA interp_D4+-1.gif"
